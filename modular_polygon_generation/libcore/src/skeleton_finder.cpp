...
namespace libcore {
    ...
    void SkeletonFinder::init(std::string config_file) {
        ...
        std::filesystem::path output_path = "../output/tests/area_1_down_sampling/";
        ...
        std::string config_path = "../modular_polygon_generation/libcore/data/configs/tests/area_1_down_sampling/" + config_file;
